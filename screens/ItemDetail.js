...
export default function ItemDetail({ route }) {
  ...
  let fakeArray = [1, 2, 3, 4];
  const { name, ingredients, productOptions } = route.params.item;
  const price = (productOptions[0].price/100).toFixed(2);
  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView>
        ...
        <FlatList
          data={fakeArray}
          renderItem={({ item, index }) => <Cell key={index} />}
        />
